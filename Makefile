...
SCRUB = env -u COMPOSE_PROJECT_NAME -u CLIENT_NAME -u CLIENT_TIMEZONE -u API_PORT \
          ...
          -u KHAL_AUTH_URL -u KHAL_TENANT -u KHAL_TOKEN_AUDIENCE \
          -u CORS_ALLOWED_ORIGINS \
          -u MCP_CANONICAL_URL -u MCP_AUDIENCE -u MCP_CONFIRMATION_KEY \
          ...
          -u LANGWATCH_NEXTAUTH_SECRET -u LANGWATCH_API_TOKEN_JWT_SECRET -u LANGWATCH_CREDENTIALS_SECRET \
          ...
          -u LANGWATCH_WORKERS_MEMORY_LIMIT -u LANGWATCH_POSTGRES_MEMORY_LIMIT \
          -u LANGWATCH_REDIS_MEMORY_LIMIT -u LANGWATCH_CLICKHOUSE_MEMORY_LIMIT \
          -u LANGWATCH_CLICKHOUSE_CPU_LIMIT
